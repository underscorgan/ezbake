...
#tar xf pe-puppetdb-4.4.1.tar.gz
cd pe-puppetdb-4.4.1
...
time ruby $PWD/../fpm.rb $extras --build-termini --realname puppetdb --enterprise-build --debug --operating-system el --os-version 7 --name pe-puppetdb --package-version 4.4.1 --release 1 --additional-dependency "puppet-agent" --user pe-puppetdb --group pe-puppetdb --chdir systemd_el
