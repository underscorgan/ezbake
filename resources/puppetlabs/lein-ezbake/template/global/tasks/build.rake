namespace :pl do
  ...
  namespace :jenkins do
    ...
    task :trigger_build_local_auth => "pl:fetch" do
      if Pkg::Config.build_pe
        job_url = "https://cinext-jenkinsmaster-enterprise-prod-1.delivery.puppetlabs.net/job/experimental_auto_various-packaging-jobs_packaging-os-clj_lein-ezbake-generic"
      else
        job_url = "https://jenkins-master-prod-1.delivery.puppetlabs.net/job/experimental_auto_various-packaging-jobs_packaging-os-clj_lein-ezbake-generic"
      end
      begin
